    ...
    <main className="max-w-site mx-auto px-8 pb-20">
      ...
      <div className="max-w-[440px] mx-auto">
        ...
        <div className="flex flex-col gap-3">
          <button
            onClick={() => showToast('Google 로그인으로 이동해요')}
            className="flex items-center justify-center gap-2.5 bg-forest text-cream rounded-full py-3.5 text-sm font-bold"
          >
            <span className="w-5 text-center">G</span> Google로 계속하기
          </button>
          <button
