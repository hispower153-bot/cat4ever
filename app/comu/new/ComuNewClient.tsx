...
export default function ComuNewClient() {
    ...
    <main className="max-w-site mx-auto px-8 pb-20">
      <div className="max-w-narrow mx-auto">
        <div className="pt-2 pb-8">
          <p className="font-accent italic text-[12.5px] tracking-[2.5px] text-forest mb-2.5">NEW POST</p>
          <h1 className="font-serif text-2xl text-forest">어떤 이야기를 나눠볼까요?</h1>
        </div>
        ...
        <button
          ...
          disabled={submitting}
          className="w-full bg-forest text-cream rounded-full py-4 font-bold text-[14.5px] disabled:opacity-50"
        >
